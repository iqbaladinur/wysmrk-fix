...
var VFile = class {
  ...
  constructor(value) {
    ...
    this.messages = [];
    this.history = [];
    this.cwd = _process2.default.cwd();
    this.value;
    this.stored;
    this.result;
    this.map;
  ...
  set path(path2) {
    if (isUrl(path2)) {
      path2 = _url.fileURLToPath.call(void 0, path2);
    }
   ...
   */
  get dirname() {
    return typeof this.path === "string" ? _path2.default.dirname(this.path) : void 0;
  }
  /**
  ...
  set dirname(dirname) {
    ...
    this.path = _path2.default.join(dirname || "", this.basename);
  }
  /**
   * Get the basename (including extname) (example: `'index.min.js'`).
   */
  get basename() {
    return typeof this.path === "string" ? _path2.default.basename(this.path) : void 0;
  }
  /**
  ...
  set basename(basename) {
    ...
    this.path = _path2.default.join(this.dirname || "", basename);
  }
  /**
   * Get the extname (including dot) (example: `'.js'`).
   */
  get extname() {
    return typeof this.path === "string" ? _path2.default.extname(this.path) : void 0;
  }
  /**
  ...
  set extname(extname) {
    ...
    this.path = _path2.default.join(this.dirname, this.stem + (extname || ""));
  }
  /**
   * Get the stem (basename w/o extname) (example: `'index.min'`).
   */
  get stem() {
    return typeof this.path === "string" ? _path2.default.basename(this.path, this.extname) : void 0;
  }
  /**
  ...
  set stem(stem) {
    ...
    this.path = _path2.default.join(this.dirname || "", stem + (this.extname || ""));
  }
  /**
   * Serialize the file.
   *
...
function assertPart(part, name) {
  if (part && part.includes(_path2.default.sep)) {
    throw new Error(
      "`" + name + "` cannot be a path: did not expect `" + _path2.default.sep + "`"
    );
  }
}
...
function normalizeSiblings(editor, entry, transform) {
  const [, path2] = entry;
  const prevEntry = _slate.Editor.previous(editor, { at: path2 });
  if (prevEntry && transform(prevEntry, entry))
    return true;
  const nextEntry = _slate.Editor.next(editor, { at: path2 });
...
function selectStartOfElement(editor, path2) {
  _slate.Transforms.select(editor, _slate.Editor.start(editor, path2));
}
function selectEndOfElement(editor, path2) {
  _slate.Transforms.select(editor, _slate.Editor.end(editor, path2));
}
...
function insertRootElement(editor, element, { at = editor.selection } = {}) {
  ...
  if (entry == null) {
    ...
    _slate.Editor.withoutNormalizing(editor, () => {
      _slate.Transforms.insertNodes(editor, element, { at });
      if (selection) {
    ...
    _slate.Editor.withoutNormalizing(editor, () => {
      _slate.Transforms.insertNodes(editor, element, { at: nextPath });
...
function AnchorEditDialog({
  ...
  const editor = _slatereact.useSlateStatic.call(void 0, );
  const [href, setHref] = _react.useState.call(void 0, element.href);
  const [title, setTitle] = _react.useState.call(void 0, element.title || "");
      ...
      "a",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { className: "--url", children: [
            ...
            element.title == null || element.title === "" ? null : /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { className: "--tooltip", children: element.title })
          ] })
        ]
      }
    ),
    ...
    return createPolicy({
      ...
      editableProps: {
        ...
        renderElement: ({ element, attributes, children }) => {
          if (element.type === "anchor") {
            return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, Anchor, { element, attributes, children });
          }
        }
      }
    });
...
function normalizeNode2(editor, entry) {
  ...
  if (entry[0].type === "code-block-line") {
    for (const [child, path2] of _slate.Node.children(editor, entry[1])) {
      if (!_slate.Element.isElement(child))
        continue;
      if (editor.isVoid(child)) {
        _slate.Transforms.removeNodes(editor, { at: path2 });
        return true;
      } else {
        _slate.Transforms.unwrapNodes(editor, { at: path2 });
        return true;
      }
    }
  }
...
function CodeBlock({
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, $CodeBlock, { className: selected ? "--selected" : "", ...attributes, children: [
    /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, $CodeBlockLanguage, { contentEditable: false, onClick, ref, children: [
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { children: element.language }),
...
function renderElement({
  ...
  if (element.type === "code-block") {
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, CodeBlock, { element, attributes, children });
  } else if (element.type === "code-block-line") {
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, CodeBlockLine, { element, attributes, children });
  }
}
...
function getIsEmpty(element) {
  return element.children.length === 1 && _slate.Node.string(element.children[0]).length === 0;
}
  ...
  return {
    ...
    editableProps: {
      renderElement: ({ element, attributes, children }) => {
        switch (element.type) {
          case "paragraph": {
            return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, Paragraph, { element, attributes, children });
          }
        }
      },
      onKeyDown: createHotkeyHandler({
...
function getEditorWidth(editor) {
  const element = _slatereact.ReactEditor.toDOMNode(editor, editor);
...
function getImageBoundsFromSlateElement(editor, element) {
  const imageContainerDOMNode = _slatereact.ReactEditor.toDOMNode(editor, element);
  ...
  const onMouseDown = _react.useCallback.call(void 0, 
    (e) => {
      ...
      const onDocumentMouseUp = () => {
        ...
        const path2 = _slatereact.ReactEditor.findPath(editor, element);
        const size2 = {
          width: nextSize.width,
          height: nextSize.height
        };
        setSize(size2);
        _slate.Transforms.setNodes(editor, size2, { at: path2 });
        setIsDragging(false);
      };
...
function ImagePresetButton({
  ...
  const onClick = _react.useCallback.call(void 0, () => {
    ...
    setSize(nextSize);
    _slate.Transforms.setNodes(editor, nextSize, { at: path2 });
...
function ImageTypeButtonGroup({
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, $ImageButtonGroup, { children: [
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, InlineImageTypeButton, { element }),
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, BlockImageTypeButton, { element })
  ] });
}
...
function ImageToolbar({
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, $ImageToolbar, { children: [
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, ImageTypeButtonGroup, { element }),
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
...
function renderElement2({
  ...
  switch (element.type) {
    case "image-block":
      return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, ImageBlock, { element, attributes, children });
    case "image-inline":
      return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, ImageInline, { element, attributes, children });
  }
}
...
function insertBreak2(editor) {
  ...
  if (_slate.Editor.isEmpty(editor, element)) {
    if (element.depth > 0) {
      _slate.Transforms.setNodes(editor, { depth: element.depth - 1 }, { at: path2 });
      return true;
    } else {
...
function OrderedListItem({
  ...
  const className = _clsx.clsx.call(void 0, { "--first-at-depth": element.__firstAtDepth });
...
function TaskListItem({
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, $TaskListItem, { ...attributes, style, children: [
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { className: "--list-item-icon", contentEditable: false, children: element.checked ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, CheckedIcon, { onClick: toggle, style: { cursor: "pointer" } }) : /* @__PURE__ */ _jsxruntime.jsx.call(void 0, UncheckedIcon, { onClick: toggle, style: { cursor: "pointer" } }) }),
    children
  ] });
}
...
function renderElement3({
  ...
  switch (element.type) {
    case "ordered-list-item":
      return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, OrderedListItem, { element, attributes, children });
    case "unordered-list-item":
      return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, UnorderedListItem, { element, attributes, children });
    case "task-list-item":
      return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, TaskListItem, { element, attributes, children });
  }
}
...
function getElementRect(editor, element) {
  return _slatereact.ReactEditor.toDOMNode(editor, element).getBoundingClientRect();
}
...
function normalizeTableCell(editor, entry) {
  ...
  _slate.Editor.withoutNormalizing(editor, () => {
    ...
    for (let i = node2.children.length; i >= 0; i--) {
      _slate.Transforms.mergeNodes(editor, { at: [...path2, i] });
    }
...
function Table({
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, TableContext.Provider, { value: { isSelected }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, $Table, { ...attributes, columns: element.columns, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "tbody", { children }) }) });
}
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    $TableCell,
    {
      ...
      children: [
        ...
        showRowMenu ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, RowMenu, { cellElement: element }) : null,
        showColumnMenu ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, ColumnMenu, { cellElement: element }) : null
      ]
    }
  );
}
...
function renderElement4({
  ...
  switch (element.type) {
    case "table":
      return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, Table, { element, attributes, children });
    case "table-row":
      return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, TableRow, { element, attributes, children });
    case "table-cell":
      return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, TableCell, { element, attributes, children });
    case "table-content":
      return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, TableContent, { element, attributes, children });
  }
}
