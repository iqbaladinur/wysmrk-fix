...
import { Element as Element$1, BaseEditor, NodeEntry, BaseRange, Location, Editor, Descendant, Text, Path, BaseText } from 'slate';
...
declare function createHeadingMethods(editor: Editor): {
    convertHeading: (level: 2 | 1 | 3 | 4 | 5 | 6, allowToggle: boolean) => void;
};
